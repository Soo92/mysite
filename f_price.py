...
path_list=['https://www.samhwasnd.com/',                                                                        'http://www.signcody.co.kr/']

cate_xpath=["(//a[@class='categoryDepthLink'])[{}]",                                                            "//div[@class='mainMenu']/ul/li[{}]/a"]
img_xpath=["//div[@id='searchedItemDisplay']/ul/li[{}]/div/div/a/img",                                          "//div[@class='goodsList']/ul/li[{}]/a/div/img"]
link_xpath=["//div[@id='searchedItemDisplay']/ul/li[{}]/ul/li[@class='caprlist_name_area']/a",                  "//div[@class='goodsList']/ul/li[{}]/a"]
no_xpath=["//div[@id='searchedItemDisplay']/ul/li[{}]/ul/li[@class='caprlist_name_area']/a/span",               "//div[@class='goodsList']/ul/li[{}]/a/div[@class='goodsname']"]
title_xpath=["//div[@id='searchedItemDisplay']/ul/li[{}]/ul/li/div[@class='goodS_info style_10_saname']",       ""]
detail_xpath=["//div[@id='searchedItemDisplay']/ul/li[{}]/ul/li[@class='goods_desc_area style_10_summary']",    "//div[@class='goodsList']/ul/li[{}]/a/div[@class='goodstype']"]
price_xpath=["//div[@id='searchedItemDisplay']/ul/li[{}]/ul/li/div/span[@class='areA']",                        "//div[@class='goodsList']/ul/li[{}]/a/div[@class='goodsprice']"]
